...
public class PlanSpec {
    ...
    public Deployment rootObject() {
        final Deployment rootObject = new Deployment(new PlanIdentifier("DSA", "PDN"),
    ...
    public static void main(String... argv) {
        ...
        //InputStreamReader inputStreamReader = new InputStreamReader(argv[0]);
        ...
        String projectKey = "";
        String planKey = "";
        System.out.println("okay" +projectKey);
        System.out.println("l" +planKey);
